  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-10 overflow-hidden relative">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-violet-500/5 via-background to-background"></div>
      ...
      >
        <div className="mb-8 text-center">
          <Link href="/" className="inline-block">
            ...
            >
              <div className="size-12 bg-violet-500/10 rounded-xl flex items-center justify-center mr-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2L5 5V19L12 22L19 19V5L12 2Z" className="fill-violet-500" />
                  <path d="M12 8L8 10V16L12 18L16 16V10L12 8Z" fill="white" />
                </svg>
              </div>
              <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-primary">
                HabitVault
              </h1>
            </motion.div>
          </Link>
