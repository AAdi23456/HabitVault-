...
export function AuthForm({ type }: AuthFormProps) {
  ...
  // Initialize forms for both login and register
  ...
  // Watch values for form state
  const watchedLoginEmail = loginForm.watch("email");
  const watchedLoginPassword = loginForm.watch("password");
  const isLoginFormFilled = watchedLoginEmail && watchedLoginPassword 
    && watchedLoginEmail.length > 0 && watchedLoginPassword.length > 0;
  ...
  const isRegisterFormFilled = watchedUsername && watchedRegisterEmail && watchedRegisterPassword 
    && watchedUsername.length > 0 && watchedRegisterEmail.length > 0 && watchedRegisterPassword.length > 0;
            ...
            <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      loginForm.formState.errors.email ? "border-destructive focus:ring-destructive/20" : "focus:border-primary"
                    )}
                  />
                </div>
                <AnimatePresence>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      loginForm.formState.errors.password ? "border-destructive focus:ring-destructive/20" : "focus:border-primary"
                    )}
                  />
                  <button
                    type="button"
              ...
              <Button
                ...
                className={cn(
                  ...
                  isLoginFormFilled ? "bg-primary hover:bg-primary/90" : "bg-primary/80"
                )}
              ...
              >
                ...
                {isLoginFormFilled && !isSubmitting && (
                  <motion.span
                    initial={{ width: 0 }}
                    animate={{ width: "100%" }}
        ...
        <CardContent>
          ...
          <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    ...
                    registerForm.formState.errors.username ? "border-destructive focus:ring-destructive/20" : "focus:border-violet-500"
                  )}
                />
              </div>
              <AnimatePresence>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "pl-9 transition-all border border-input rounded-md focus:ring-2 focus:ring-violet-500/20",
                    registerForm.formState.errors.email ? "border-destructive focus:ring-destructive/20" : "focus:border-violet-500"
                  )}
                />
              </div>
              <AnimatePresence>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    ...
                    registerForm.formState.errors.password ? "border-destructive focus:ring-destructive/20" : "focus:border-violet-500"
                  )}
                />
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="h-1.5 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <motion.div 
                      initial={{ width: 0 }}
                      animate={{ 
                        width: watchedRegisterPassword.length >= 12 ? '100%' : 
                              watchedRegisterPassword.length >= 10 ? '75%' :
                              watchedRegisterPassword.length >= 8 ? '50%' : '25%' 
                      }}
                      className={cn(
                        "h-full",
                        watchedRegisterPassword.length >= 12 ? 'bg-green-500' :
                        watchedRegisterPassword.length >= 10 ? 'bg-yellow-500' :
                        watchedRegisterPassword.length >= 8 ? 'bg-orange-500' : 'bg-red-500'
                      )}
                    />
                  </div>
                </motion.div>
            ...
            <Button
              ...
              className={cn(
                "w-full relative overflow-hidden transition-all duration-300",
                isRegisterFormFilled ? "bg-violet-600 hover:bg-violet-700" : "bg-violet-600/80"
              )}
              disabled={isSubmitting}
            >
              {isSubmitting ? (
              ...
              {isRegisterFormFilled && !isSubmitting && (
                <motion.span
                  initial={{ width: 0 }}
                  animate={{ width: "100%" }}
                  className="absolute bottom-0 left-0 h-1 bg-white/20"
